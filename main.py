...
geobot = Agent(name="geobot", seed="geobot recovery phrase")

@geobot.on_interval(period=5)
async def get_temp(ctx: Context):
    ctx.logger.info(CheckWeather())
...
if __name__ == "__main__":
    ...
    if tdf.upper() == 'N':
        ...
        for i in range(5):
            ...
            print("Failed to record user input. Taking Default value of",dmin_temp,"°C")
